...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityName").keydown(function (event) {
			if (event.keyCode==13){
				//使用Ajax
				$.ajax({
					url:"workbench/clue/findActivityByAName.do",
					type:"get",
					data:{
						//获取的是用户输入的内容
		...
		$("#bundBtn").click(function () {
			...
			if ($xz.length==0){
				...
				//使用Ajax,把参数传送到后台
				$.ajax({
					url:"workbench/clue/bundBtnSave.do",
					type:"post",
					data:params,
					dataType:"json",
					success:function (data) {
	...
	function showActivityList() {
		...
		$.ajax({
			...
			dataType:"json",
			success:function (data) {
				//后台返回的是，市场活动信息[{市场活动1},{市场活动2},{市场活动3},{市场活动4},`````]
				var html="";
				$.each(data,function (i,n) {
					html+='<tr>';
					html+='<td>'+n.name+'</td>';
				...
				$("#showActivityInfoByClueId").html(html);
			}
		})
	}
	function unBound(id) {
		//根据id删除单条
		$.ajax({
			url: "workbench/clue/deleteByIdInRelation.do",
			type: "post",
			data: {
				"id":id
			},
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="activityName" class="form-control" style="width: 300px;" placeholder="111请输入市场活动名称，支持模糊查询">
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${clue.job}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">公司座机</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${clue.email}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table class="table table-hover" style="width: 900px;">
					...
					<tbody id="showActivityInfoByClueId">
						<%--<tr>
							<td>发传单</td>
							<td>2020-10-10</td>
							<td>2020-10-20</td>
